	...
	<div class="container-fluid border col-lg-5 col-md-6 mt-5 p-4" >
		...
		<form method="post">
			...
			<div class="input-group mb-3">
			  ...
			  <input value="<?=set_value('password','')?>" name="password" type="text" class="form-control  <?=!empty($errors['password']) ? 'border-danger':''?>" placeholder="Password(Leave Blank to Not Change)" aria-label="Password" aria-describedby="basic-addon1">
				<br>
			...
			<div class="input-group mb-3">
			  ...
			  <input value="<?=set_value('password_retype','')?>" name="password_retype" type="text" class="form-control  <?=!empty($errors['password_retype']) ? 'border-danger':''?>" placeholder="Retype Password(Leave Blank to Not Change)" aria-label="Username" aria-describedby="basic-addon1">
